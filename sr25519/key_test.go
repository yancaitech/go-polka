...
func TestCreateAddress(t *testing.T) {
	...
	pubK, _ := key.ExpandEd25519().Public()
	pp := pubK.Encode()
	...
	/*
		718b88b8a4df1334265cc726d8cdaedde106fe7eaddea82a1bb457e0011c38d4
		=============
		a64edb322466a2b923dc5b3d7bd36bbeef1d06bb8d117dd2c6e871ab252c670f
		404a411f1da217e155b04e6198f4b857ceaad2270b08cc2ee93ef5888d564745
		12TJ882oCKhKBpCsfSgcBbzP7StujxZm4wGQJcSoV1fCBi8V <nil>
		PASS
	*/
}
...
func TestCreateAddress3(t *testing.T) {
	...
	address, err := CreateAddress(pub, config.PolkadotPrefix)
	if err != nil {
		panic(err)
	}
	fmt.Println(private)
